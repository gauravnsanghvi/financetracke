...
switch ($selectedSort) {
    case 'month':
        ...
        break;
    case 'category':
        $sortColumn = 'incomecategory';
        break;
    case 'none':
    default:
        $sortColumn = 'id DESC'; // Sort by ID in descending order (recently added)
        break;
}
...
$exp_fetched = mysqli_query($con, "SELECT * FROM income WHERE user_id = '$userid' $orderByClause");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="income.php" class="list-group-item list-group-item-action "><span data-feather="plus-square"></span> Add Expenses</a>
        <a href="income.php" class="list-group-item list-group-item-action"><span data-feather="plus-square"></span> Add Income</a>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php $count=1; while ($row = mysqli_fetch_array($exp_fetched)) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $row['income_date']; ?></td>
                                    <td class="text-center"><?php echo $row['income']; ?></td>
                                    <td class="text-center"><?php echo $row['incomecategory']; ?></td>
                                    <td class="text-center">
                                        <a href="income.php?edit=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm" style="border-radius:0%;">Edit</a>
                                    </td>
                                    <td class="text-center">
                                        <a href="income.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" style="border-radius:0%;">Delete</a>
                                    </td>
                                </tr>
                            <?php $count++; } ?>
                        </table>
