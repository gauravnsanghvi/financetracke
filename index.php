...
$total_expense = mysqli_query($con, "SELECT SUM(income) FROM income WHERE user_id = '$userid'");
...
$total_expense_amount = '0' + mysqli_fetch_assoc($total_expense)['SUM(income)'];
...
<body>
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="card text-center">
        <div class="card-body">
          <h5 class="card-title">Month Income</h5>
